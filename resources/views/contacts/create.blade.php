                        ...
                        <div class="form-group text-center">
                            ...
                            <div class="fileinput fileinput-new" data-provides="fileinput">
                                ...
                                <div>
                                    ...
                                    <span class="btn btn-primary btn-file btn-contact-form"><span class="fileinput-new"><i class="glyphicon glyphicon-camera"></i> Dodaj zdjęcie</span><input type="file" value="" accept="image/*" name="image" class="image-input"></span>
